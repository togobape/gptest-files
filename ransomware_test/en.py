...
# --- Paths ---
FOLDER       = os.path.join(os.path.expanduser("~"), "Desktop", "amit_test", "gptest", "test_enc_file")
PUBLIC_KEY_F = os.path.join(os.path.dirname(os.path.abspath(__file__)), "pk.pem")
